...
CoarseTracker::CoarseTracker(int ww, int hh, const std::vector<double> &tfm_vec,
                             const Mat33f &K1)
...
void CoarseTracker::calcGSSSEPose(int lvl, Mat88 &H_out, Vec8 &b_out,
...
Vec6 CoarseTracker::calcResPose(int lvl, const SE3 &refToNew, AffLight aff_g2l,
